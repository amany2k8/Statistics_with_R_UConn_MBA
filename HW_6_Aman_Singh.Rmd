...
z<-rnorm(10,65,4.69)
cor(y,z)
COr_sim<-replicate(1000, cor(y,z))
```
...
y<-rnorm(100,15,1)
z<-rnorm(100,65,4.69)
print(Sum_Sim<-mean(replicate(1000,y+z)))
...
print(Sim_sample_mean<-mean(replicate(1000,x)))
print(Sim_sample_sd<-sd(replicate(1000,x)))
```
...
set.seed(100)
x<-rnorm(10,120000,10000)
print(Sim_sample_mean2<-mean(replicate(10000,x)))
print(Sim_sample_sd2<-sd(replicate(10000,x)))
```
...
set.seed(100)
x<-rnorm(10,120000,10000)
print(Sim_sample_mean3<-mean(replicate(100000,x)))
print(Sim_sample_sd3<-sd(replicate(100000,x)))
```
##Problem_3.e
